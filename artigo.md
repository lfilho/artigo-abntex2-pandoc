...
Destarte, este trabalho visa identificar alguns destes possíveis benefícios secundários e corroborar e confrontar os mesmos à realidade de uma empresa de desenvolvimento de software.
...
Para este artigo foi adotada uma abordagem qualitativa e o mesmo constitui-se de caráter exploratório. Para tal foi escolhida uma empresa de desenvolvimento de software. Nesta empresa, de pequeno porte, já aconteceram esforços de modelagem de processos no passado, tornando-a ideal para ter seu caso estudado. Nela foi conduzida uma pesquisa com desdobramentos quantitativos e também qualitativos sobre o resultados desses prévios esforços.
...
A modelagem de processos é uma expressão gráfica de como as organizações executam seus processos \cite{enivaldobpm}; é também um dos principais artefados produzidos por um empreendimento de BPM. É só à partir dela que outras etapas da Gestão de Processos se dão, tais quais análises, automação ou monitoramentos de desempenho.

Dentre todas as possíveis etapas e produtos de um emprendimento BPM, a modelagem é uma "fruta madura em galho baixo" pois os diagramas resultantes da mesma: são fáceis de entender quando comparados a outras formas de documentação, fornecem uma linha-base para a medição, facilitam o processo de simulação e análise de impacto mas, e não obstante, são relativamente rápidos, fáceis e baratos de se produzir \cite{enivaldobpm}.
...
// TODO: sugestão de continuidade: pesquisas de satisfação entre colaboradores sobre o que poderia ser feito para melhorar o engajamento e a cultura de colaboração da empresa; pesquisas gerais no mercado sobre o que levou um trabalhor a querer sair de uma empresa; pesquisas sobre fatores que levam alguém a se engajar num trabalho.
